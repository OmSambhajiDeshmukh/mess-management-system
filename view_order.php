                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        // Check if this is the format from order_food.php
                                        if (isset($order['meal_type']) && isset($order['food_item']) && isset($order['price'])) {
                                            $price = (float)$order['price'];
                                            $total += $price;
                                            ?>
                                            <tr>
                                                <td><?php echo htmlspecialchars($order['meal_type'] . ': ' . $order['food_item']); ?></td>
                                                <td>1</td>
                                        ...
                                        // Check if items data exists in the traditional format
                                        elseif (isset($items_json) && !empty($items_json)) {
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th>
                                                <?php 
                                                // Check different types of price fields
                                                $display_total = $total;
                                                if (isset($order['total_amount']) && $order['total_amount'] > 0) {
                                                    $display_total = (float)$order['total_amount'];
                                                } elseif (isset($order['price']) && $order['price'] > 0) {
                                                    $display_total = (float)$order['price'];
                                                }
                            ...
                            <form method="POST" action="">
                                <div class="mb-3">
                                    ...
                                    <select name="status" id="status" class="form-select">
                                        ...
                                        <option value="approved" <?php echo (strtolower($order['status']) == 'approved') ? 'selected' : ''; ?>>Approved</option>
                                        ...
                                        <option value="rejected" <?php echo (strtolower($order['status']) == 'rejected') ? 'selected' : ''; ?>>Rejected</option>
